...
<?php
$sql = $db->query("SELECT DISTINCT section FROM student_registered");
...
for ($i = 0; $i < count($result); $i++) {
   $section = ($result[$i][0]);
   // echo $section;
   $check = $db->query("SELECT gender,section FROM student_registered WHERE section='$section' AND gender='Male'");
