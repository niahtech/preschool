                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><?= getClass($result['class'])['name']?> Student from <?=getDept($result['department'])['name']?></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="card-body dash-widget1 dash-widget2">
                                            ...
                                            <div class="dash-details">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><i class="fas fa-hourglass-end"></i> 60 Minutes</li>
                                                    <li><i class="fas fa-clipboard-check"></i> 6 Assignment</li>
                                                </ul>
                                                <div class="dash-btn">
                                                    <button type="submit" class="btn btn-info btn-border">Skip</button>
                                                    <button type="submit" class="btn btn-info">Continue</button>
