                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="about-info">
                                ...
                                <div class="media-body">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <span class="info-span"><?= getLecturer($_SESSION['email'], 'email'); ?></span>
                                            <!-- <a href="https://preschool.dreamguystech.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a3c7c2cad0dae3c4cec2cacf8dc0ccce">[email&#160;protected]</a> -->
                                        </li>
                                        <li>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <p>Hello I am <?= getLecturer($_SESSION['email'], 'name'); ?>. A lecturer in the Preschool Academy founded in the year 2023.</p>
                                </div>
                            </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" class="form-control" value="<?= getLecturer($_SESSION['email'], 'email') ?>" name="email" readonly>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <?php if(isset($_GET['pwdErr'])){
                                        if($_GET['pwdErr'] == 'incorrect'){?>
                                            <div class="col-12 col-sm-6 form-group" style="color:red"><?= 'Incorrect Password'; ?></div>
                                            <?php 
                                        }
                                        if($_GET['pwdErr'] == 'successful'){?>
                                            <div class="col-12 col-sm-6 form-group" style="color:green"><?= 'Successfully Updated'; ?></div>
                                            <?php 
                                        }
                                    }?>
