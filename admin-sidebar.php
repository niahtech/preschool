            ...
            <div class="sidebar-inner slimscroll">
               <div id="sidebar-menu" class="sidebar-menu">
                  <ul>
                     ...
                     <li class="submenu">
                        <a href="#"><i class="fas fa-building"></i> <span> Class Management</span> <span class="menu-arrow"></span></a>
                        <ul>
                           <li><a href="manage_class.php">Class List</a></li>
                        </ul>
                     </li>
                     <li class="submenu">
                           <a href="#"><i class="fas fa-book-reader"></i> <span> Courses</span> <span class="menu-arrow"></span></a>
                           <ul>   
                              <li><a href="coursemanagement.php" class="submenu "><span>Course Lists</span><span class="menu-arrow"></span></a>
                              </li>
                        </ul></li>
                     <li class="menu-title">
